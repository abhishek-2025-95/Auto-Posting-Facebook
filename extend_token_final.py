#!/usr/bin/env python3
"""
Facebook Token Extender - Final Version
Extends token using your App ID and App Secret
"""
...
def extend_token_final():
    """
    Extend token using your App ID and App Secret
    """
    print("="*60)
    print("EXTENDING FACEBOOK TOKEN - FINAL VERSION")
    print("="*60)
    
    app_id = "830755816088454"
    app_secret = "5c17cb178812b27a84450ffe22bcf099"
    ...
    try:
        # Step 1: Extend token to long-lived
        print("\nStep 1: Extending token to long-lived...")
...
def main():
    """Main function"""
    print("FACEBOOK TOKEN EXTENDER - FINAL VERSION")
    print("Using your App ID and App Secret")
