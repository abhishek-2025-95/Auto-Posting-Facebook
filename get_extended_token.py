#!/usr/bin/env python3
"""
Get the extended token from the successful extension
"""
...
def get_extended_token():
    """
    Get the extended token using the same process
    """
    print("="*60)
    print("GETTING EXTENDED FACEBOOK TOKEN")
    print("="*60)
    ...
    try:
        ...
        print("Step 1: Extending token to long-lived...")
            ...
            if long_lived_token:
                ...
                if page_token:
                    ...
                    if validate_token(page_token):
                        ...
                        # Step 4: Save token info (without datetime objects)
                        token_info = {
